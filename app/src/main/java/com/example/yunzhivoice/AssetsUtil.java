...
public class AssetsUtil {
   ...
   /* public boolean copy() throws IOException {
        ...
        mAppDirectory = new File(VoiceUtil.TEMP_DIR);
        if (!mAppDirectory.exists()) {
            mAppDirectory.mkdirs();
        } else {
            if (mAppDirectory.listFiles().length==5){
                System.out.println("跳过拷贝！");
                return true;
            }
        }
...
//        System.out.println(mAppDirectory);
     ...
     * @throws IOException
     */
    public  File copy(String mAppDirectory,String asset) throws IOException {
